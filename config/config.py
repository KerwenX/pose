...
flags.DEFINE_string('dataset_dir', '/home/aston/Desktop/Datasets/NOCS', 'path to the dataset')
flags.DEFINE_string('detection_dir', '/home/aston/Downloads/data/segmentation_results', 'path to detection results')
...
flags.DEFINE_string('resume_model', '/home/aston/Desktop/python/HS-Pose/engine/output/models/remote/model_139.pth', 'path to the saved model')
