...
class ScanNetDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # rectangle = plt.Rectangle((bbox_xyxy[0], bbox_xyxy[1]), width, height, fill=False, edgecolor = 'red',linewidth=1)
        # ax.add_patch(rectangle)
        # ax.scatter(bbox_center[0],bbox_center[1],marker='o',s=20,color='r')
        # plt.show()
        ## roi_image ------------------------------------
        ...
        # TODO transfer nocs_scales(3) ---> nocs_scales(1), np.mean()
